...
namespace OSIProject
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "SAGE OSI Project", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension)]
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "osiproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "OSIProject";

        internal const string Language = "SAGE OSI";
